class Cart {
    ...
    initialize() {
        ...
        this.pass = findInArray(this.start, this.line.StationsOnLine);
        this.pass_station = this.line.StationsOnLine[this.pass];
        this.next_station = this.line.StationsOnLine[this.pass + this.direction];
    ...
    update() {
        ...
        if (((this.next_station.PosX - this.pass_station.PosX > 0) && (this.posX > this.next_station.PosX - METRO_WIDTH / 2)) ||
            ...
            if (this.pass == this.line.StationsOnLine.length - 1 || this.pass == 0) {
